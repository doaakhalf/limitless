  ...
  <nav class="navbar navbar-default navbar-fixed navbar-transparent white bootsnav on no-full">
    ...
    <div class="container">
      ...
      <div class="navbar-header">
        ...
        <div class="logo"> <a href="index.html"> <img class="logo logo-display" src="assets/images/logo2-white.png" alt=""> <img class="logo logo-scrolled" src="assets/images/logo2-black.png" alt=""> </a> </div>
      </div>
...
<div class="tp-bannertimer tp-bottom" style="visibility: hidden !important;"></div>	</div>
  	...
  	<div class="container-fluid">
    	<div class="row">
        	<div class="col-sm-8 section-heading">
					   <h2 class="mt-0 font-700">Our Recent Works</h2>
					   <h4 class="default-color font-600">Over 8 years of design experience and thousands <br>of projects make us professionals</h4>
			    </div>

            <div class="col-md-12">

            <div id="portfolio-gallery" class="cbp mt-80">
                ...
                <div class="cbp-item col-md-2 col-sm-3 with-spacing">
                    <div class="cbp-item-wrapper">
                    	<div class="portfolio gallery-image-hover text-center">
                    		<div class="folio-overlay"></div>
  ...
  <!--== Video Start ==-->
  <section class="parallax-bg fixed-bg" data-parallax-bg-image="assets/images/background/parallax-bg-4.jpg" data-parallax-speed="0.5" data-parallax-direction="up">
  	<div class="parallax-overlay"></div>
  	<div class="container">
  		<div class="row">
  			<div class="col-md-8 parallax-content text-center">
          ...
          <h5 class="grey-color mt-30">Objectively innovate empowered manufactured products whereas parallel platforms. Holisticly predominate extensible testing procedures for reliable supply chains. Dramatically engage top-line web services vis-a-vis <br> cutting-edge deliverables.</h5>
  			</div>
      ...
      <div class="row">
        <div class="col-md-3 col-sm-6">
          <div class="counter-wrap wow fadeInRight white-color" data-wow-delay="0.1s">
            <i class="icon-anchor font-40px"></i>
        ...
        <div class="col-md-3 col-sm-6">
          <div class="counter-wrap wow fadeInRight white-color" data-wow-delay="0.2s">
            <i class="icon-camera font-40px"></i>
        ...
        <div class="col-md-3 col-sm-6">
          <div class="counter-wrap wow fadeInRight white-color" data-wow-delay="0.3s">
            <i class="icon-wallet font-40px"></i>
  ...
  <!--== Little Info Start ==-->
  <section>
    <div class="col-md-6 col-sm-12 bg-flex bg-flex-right">
      <div class="bg-flex-holder bg-flex-cover" style="background-image: url(assets/images/bg-right-img-3.jpg);"></div>
    </div>
    <div class="container-fluid">
      <div class="col-md-5 col-sm-7">
        <div class="pl-120">
          <h5 class="default-color mt-0">Digitally Forward Creative</h5>
          <h2 class="mt-0 font-700">Innovation in Digital Media <br>Consulting Excellence.</h2>
          <div class="row mt-80">
                <div class="col-md-12 feature-box mb-50 col-sm-6 col-lg-6">
                	<i class="icon-paintbrush font-40px default-color"></i>
                  <h5 class="mt-0 font-600">Productivity</h5>
                  <p class="mt-30">Lorem ipsum dolor sit amet consectetur adipiscing elit. Sed rhoncus a urna id semper.</p>
                </div>
                <div class="col-md-12 feature-box mb-50 col-sm-6 col-lg-6">
                	<i class="icon-streetsign font-40px default-color"></i>
                  <h5 class="mt-0 font-600">Innovative Ideas</h5>
                  <p class="mt-30">Lorem ipsum dolor sit amet consectetur adipiscing elit. Sed rhoncus a urna id semper.</p>
                </div>
                <div class="col-md-12 feature-box mb-50 col-sm-6 col-lg-6">
  				        <i class="icon-aperture font-40px default-color"></i>
                  <h5 class="mt-0 font-600">Code Ninja's</h5>
                  <p class="mt-30">Lorem ipsum dolor sit amet consectetur adipiscing elit. Sed rhoncus a urna id semper.</p>
                </div>
                <div class="col-md-12 feature-box mb-50 col-sm-6 col-lg-6">
               	<i class="icon-mobile font-40px default-color"></i>
                  <h5 class="mt-0 font-600">Elegant Design</h5>
                  <p class="mt-30">Lorem ipsum dolor sit amet consectetur adipiscing elit. Sed rhoncus a urna id semper.</p>
                </div>
              </div>
          </div>
  ...
  <section class="white-bg">
    <div class="container">
      <div class="row">
        <div class="col-sm-8 section-heading">
          <h2 class="mt-0 font-600">Updated News</h2>
        ...
        <div class="row">
          <div class="col-sm-6 col-md-4">
            <div class="widget widget-text">
              <div class="logo logo-footer"><a href="index.html"> <img class="logo logo-display" src="assets/images/logo2-footer-light.png" alt=""></a> </div>

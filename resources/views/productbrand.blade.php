...
li a{
      ...
      <section class="title-hero-bg parallax-effect removegray" style='background:white transform: translateY(70.4537px);'>
        <div class="container">
            <div class="page-title text-center white-color">
                ...
                <img  width="400" src="{{asset('/assets/images/clients/'.$product->logo2)}}" style="max-height: 315px;">
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-8 col-sm-8 col-xs-12 xs-mb-30">
          ...
          @else
          <img  width="500" src="{{asset('assets/images/announce/'.$product->logo)}}" style="max-height: 370px;">
          @endif
  ...
  <section class="parallax-bg fixed-bg" data-parallax-bg-image="{{asset('assets/images/background/pattern-bg-memphis.jpg')}}" data-parallax-speed="0.5" data-parallax-direction="left">
    <div class="parallax-overlay" style="background: rgb(128, 44, 113)"></div>
    <div class="container">
      <div class="row">
          ...
          @foreach($product_images as $product_image)
            <div class="col-md-4 col-sm-4 col-xs-12">
              <img src="{{asset('assets/images/announce/'.$product_image->image)}}" />
            </div>
            @endforeach

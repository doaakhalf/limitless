  ...
  <section class="grey-bg pt-80 pb-80 clientslogo">
    <div class="container">
      <div class="row">
		...
		<div class="client-logo"> <a href="{{url('product')}}/{{$client['product_id']}}"><img class="img-responsive" src="assets/images/clients/{{$client->logo}}" alt="01"/></a></div>
		@endforeach
		  ...
		  <div class="client-logo"> <img class="img-responsive" src="assets/images/clients/11.png" alt="11"/> </div>
		  <div class="client-logo"> <img class="img-responsive" src="assets/images/clients/12.png" alt="12"/> </div>
		  <div class="client-logo"> <img class="img-responsive" src="assets/images/clients/13.png" alt="13"/> </div>
		  <div class="client-logo"> <img class="img-responsive" src="assets/images/clients/14.png" alt="14"/> </div> -->
        </div>
      </div>
    </div>
  </section>
          ...
          <div class="col-sm-6 col-md-3">
            <div class="widget widget-links">
              ...
              <div class="widget-links">
                  <ul>
				   <li>124 Al Banafseg 1St district new cairo egypt</li>
                    <li>(02) 2308 3965</li>
                    <li><a href="mailto:info@pbc-egy.com">info@pbc-egy.com</a></li>
                    <li> <a href="https://pbc-egy.com/public/">PBC</a></li>
                  </ul>
              </div>
            </div>
          </div>

...
class RolesController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('dashboard.roles.roles_list')->with($params);
    }
    ...
    public function create()
    {
        ...
        return view('dashboard.roles.roles_create')->with($params);
    }
    ...
    public function show($id)
    {
        ...
        try {
            ...
            return view('dashboard.roles.roles_delete')->with($params);
    ...
    public function edit($id)
    {
        ...
        try {
            ...
            return view('dashboard.roles.roles_edit')->with($params);
        } catch (ModelNotFoundException $ex) {
            if ($ex instanceof ModelNotFoundException) {
                return response()->view('errors.' . '404');
            }

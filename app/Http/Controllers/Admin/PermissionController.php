...
class PermissionController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('dashboard.permission.perm_list')->with($params);
    }
    ...
    public function create()
    {
        ...
        return view('dashboard.permission.perm_create')->with($params);
    }
    ...
    public function show($id)
    {
        ...
        try {
            ...
            return view('dashboard.permission.perm_delete')->with($params);
    ...
    public function edit($id)
    {
        ...
        try {
            ...
            return view('dashboard.permission.perm_edit')->with($params);
        } catch (ModelNotFoundException $ex) {
            if ($ex instanceof ModelNotFoundException) {
                return response()->view('errors.' . '404');
            }

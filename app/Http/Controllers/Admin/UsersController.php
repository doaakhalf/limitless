...
class UsersController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('dashboard.users.users_list')->with($params);
    }
    ...
    public function create()
    {
        ...
        return view('dashboard.users.users_create')->with($params);
    }
    ...
    public function show($id)
    {
        try {
            ...
            return view('dashboard.users.users_delete')->with($params);
    ...
    public function edit($id)
    {
        try {
            ...
            return view('dashboard.users.users_edit')->with($params);
        } catch (ModelNotFoundException $ex) {
            if ($ex instanceof ModelNotFoundException) {
                return response()->view('errors.' . '404');
            }
